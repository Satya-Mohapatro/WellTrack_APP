                    ...
                    Row(
                      ...
                      children: [
                        Align(
                          ...
                          child: Padding(
                            padding:
                                EdgeInsetsDirectional.fromSTEB(80, 60, 0, 0),
                            child: ClipRRect(
                                ...
                                onPressed: () async {
                                  await ProfileRecord.collection
                                      ...
                                      .set(createProfileRecordData(
                                        name: _model.fullNameController1.text,
                                        contact:
                                            _model.contactNoController.text,
                                        birthdate: _model.datePicked,
                                        gender: _model.dropDownValue,
                                        email: _model.fullNameController1.text,
                                      ));
                                  await showDialog(
                                    context: context,
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        title: Text(_model.dropDownValue!),
                                        actions: [
                                          TextButton(
